...
const PLANS = [
  {
    ...
    features: ['LV cable sizing · Unlimited', 'Voltage drop check', 'AI assistant · 50/mo', 'Calculation history · last 10'],
  ...
  },
  {
    ...
    features: ['Everything in Free', 'Unlimited LV sizing', 'AI assistant · 500/mo', 'Short circuit · Motor sizing', 'Aluminium sizing', 'PDF report export', 'Unlimited history'],
  ...
  },
  {
    ...
    features: ['Everything in Pro', 'AI assistant · 3,000/mo', 'ABC cable (NFC 33-209)', 'Busbar sizing (Cu & Al)', 'Multi-user team access', 'API access', 'Priority support', 'Custom branding on reports'],
    excluded: [],
...
const COMPARE = [
  { feat: 'LV cable sizing',    ref: 'BS7671 4D1–4E5',     free: 'Unlimited', pro: 'Unlimited', biz: 'Unlimited' },
  { feat: 'Voltage drop check', ref: 'Sec 525',            free: true,     pro: true,        biz: true },
  { feat: 'AI assistant',       ref: 'Claude',             free: '50/mo',  pro: '500/mo',    biz: '3,000/mo' },
  ...
  { feat: 'History',            ref: '',                   free: 'Last 10', pro: 'Unlimited', biz: 'Unlimited' },
