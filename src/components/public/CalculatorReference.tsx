...
/**
 * The reference material that sits under the calculator on /calculator.
 *
 * Lives in its own component because the page it used to belong to
 * (pages/public/PublicCalculator) has been retired: with the paid tiers gone,
 * every calculator is available to everyone, so anonymous visitors now get the
 * full workspace rather than a cut-down LV-only page. Keeping this content on
 * the same URL means crawlers and users see the same page — the workspace is
 * interactive on top of it, not instead of it.
 */
...
export default function CalculatorReference() {
  return (
    <>
